# Runbook — sdkwork-local-router deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-local-router-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-local-router/bundle`, loads the image, starts
