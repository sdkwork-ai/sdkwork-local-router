...
Module `sdkwork-local-router` · runtime code `local_router` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `local-router-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `local-router-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `local-router-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `local-router-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `local-router.sdkwork.com` | 443 ssl + 80 |
