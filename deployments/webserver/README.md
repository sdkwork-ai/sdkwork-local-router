...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `local-router-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `local-router-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `local-router-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `local-router.sdkwork.com` | 443 ssl + 80 |
